...
legend_elements = [
    ...
    Patch(facecolor='#EE1289', label='materiaal rit ending at ehvbst'),
    Patch(facecolor='#FF3E96', label='materiaal rit ending at ehvapt'),
    Patch(facecolor='lightgrey', label='idle'),
    Patch(facecolor='#00EE00', label='opladen'),
    Patch(facecolor='#C1FFC1', label='materiaalrit naar oplaadpunt')
]
